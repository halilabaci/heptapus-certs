      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white shadow-2xl p-8 z-10">
        ...
        {done ? (
          <div className="text-center py-6 space-y-4">
            ...
            <p className="text-sm text-gray-500">Şirket tesciliniz tamamlandığında sizinle iletişime ge⌟eğiz. Teşekkürler!</p>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  placeholder="Kullanım amaüınız veya sorularınız..."
                  value={note}
